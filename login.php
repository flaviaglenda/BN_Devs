...
<html lang="pt-br">
    <head>
        ...
        <title>Login - Boas Novas Papelaria</title>
        ...
        <main id="corpo">
          <div id="login">
            <div id="cadastrar">
              ...
              <button class="butãodesima">cadastrar</button>
              <button class="butãodesima">login</button>
            </div>
            <section>

              <form id="formulario" action="./conta.php">
                <div>
                  <img class="icon" src="./img/envelope.png" alt="">
                  <input class="question" type="email" id="email" name="email" placeholder="Email" required>
                  <label for="email"></label>
                 </div>
                  <hr>
                  <div>
                    <img class="icon" src="./img/phone-call.png" alt="">
                <input class="question"   type="number" id="numero" name="telefone" placeholder="Telefone" required>
                <label for="numero"></label>
                </div>
                <hr>
                <div>
                  <img class="diferente" src="./img/3917642.png" alt="">
                <input class="question"   type="password" id="senha" name="secreto" placeholder="Senha" required>
                <label for="senha"></label>
                </div>
                <hr>
            </section>
            <section>
              <div id="botãosdebaixo">

                <button class="bonito"><img class="logocom" src="./img/google-37.png" alt="">Continuar com Google</button>  
                <button class="bonito"><img class="logocom" src="./img/download (2).png" alt="">Conttinuar com facebook</button>
                <button class="ládebaixo">Entrar</button>
              </div>
              </section>
              <div id="fim">

                <img class="iconfim"   src="./img/logo-boasnovas.png" alt="">
                <p id="papelaria">Papelaria Digital</p>
              </div>
          </form>
          </div>
